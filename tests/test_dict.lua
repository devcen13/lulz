...
function TestDictClone:test_clone_number()
  local value = 5
  self:assert_equal(dict.clone(value), value)
end
...
function TestDictExtend:test_extend_nil_equal()
  local value = {}
  self:assert_equal(dict.extend(value, nil), value)
end

function TestDictExtend:test_extend_empty_equal()
  local value = { x = 0 }
  self:assert_equal(dict.extend(value, {}), value)
end

function TestDictExtend:test_simple_extend()
  local value = { x = 0 }
  self:assert_equal(dict.extend(value, { y = 0 }), { x = 0, y = 0 })
end

function TestDictExtend:test_recursive_extend()
  local value = { x = { x = 0 } }
  self:assert_equal(dict.extend(value, { x = { y = 3 }, y = {} }), { x = { x = 0, y = 3 }, y = {} })
end

function TestDictExtend:test_extend_change_type()
  local value = { x = { x = 0 } }
  self:assert_equal(dict.extend(value, { x = 3, y = {} }), { x = 3, y = {} })
end

function TestDictExtend:test_extend_override_policy()
  local value = { x = { x = 0, y = {} } }
  local overrides = { x = { x = 1, y = { 0, 1, 2 } }, y = { y = 2 } }
  local extended = dict.extend(value, overrides, dict.override)
...
function TestDictExtend:test_extend_add_key_policy()
  local value = { x = { x = 0, y = {} } }
  local overrides = { x = { x = 1, y = { 0, 1, 2 } }, y = { y = 2 } }
  local extended = dict.extend(value, overrides, dict.add_key)
...
function TestDictExtend:test_extend_clone_policy()
  local value = { x = { x = 0, y = {} } }
  local overrides = { x = { x = 1, y = { 0, 1, 2 } }, y = { y = 2 } }
  local extended = dict.extend(value, overrides, dict.clone_new_items)
  self:assert_equal(extended, { x = { x = 1, y = { 0, 1, 2 } }, y = { y = 2 } })
  overrides.y.y = 5
  self:assert_equal(extended, { x = { x = 1, y = { 0, 1, 2 } }, y = { y = 2 } })
end
